...
VETO_MARKERS = [
    ...
    r"graduatori\w*",
    r"\bnomin[ae]\b",
    r"commission\w* giudicatric\w*",
    r"aggiudicazi\w+",
    r"\bverbale\b",
    r"esit[oi]\b.{0,20}(selezion|valutazion|candidat|graduatori|avviso)",
    r"\bconvocazione\b",
    r"avviso di rettifica",
    r"decret\w+\b.{0,40}(conferiment|attribuzion|approvazion|esclusion|aggiudicaz|graduatori|incaric|cumulativ)",
    r"determin\w+\b.{0,30}(conferiment|attribuzion|aggiudicaz|a contrarre|dirigenzial|impegno|affidamento|liquidazion|indagine|incaric)",
    r"autoattestazione",
    r"autovalutazione",
    r"valutazion\w* (delle )?candidat\w+",
    # un CONTRATTO firmato e' a valle del bando (incarico gia' assegnato)
    r"contratt[oi]\b.{0,25}(espert|prestazione d'?opera|collaborazione plurima|stipulat|sottoscritt|occasional)",
    r"\bco\.?co\.?co\b",
    r"anagrafe delle prestazion\w*",
    # --- NON sono bandi: allegati, moduli, regolamenti, CV, atti contabili ---
    r"\bscheda\b",
    r"modulistic",
    r"\bmodul[oi]\b.{0,20}(di )?(domanda|richiesta|volontari|autorizzazione|ingresso)",
    r"raccolta dei moduli",
